        ...
        <div>
                    ...
                    return (
                        <div className="post-list">
                            ...
                            <button id="delete" onClick={() => {
                                //누른 내용 데이터가 삭제
                                let temp = [...news];
                                temp.splice(index, 1); //새로 생성된 인덱스 위치에서 1개 배열 삭제. 
                                setNews(temp);
            ...
            <div>
                ...
                <button onClick={()=>{
                    ...
                    inputText = inputText.trim(); //미리 trim함수사용 띄어쓰기 제외 trim()함수

                    //if(inputText.trim() == '')
                    //if(inputText == '')
                    //if(inputText.length == 0)

                    if (inputText == ''  //완벽하게 막을 방법
                        ||inputText.length == 0
                        ||inputText == null
                        ||inputText == undefined ) {  
                        alert('값을 입력해주세요.');
                    ...
                    document.getElementById('input_news').value = ''; //텍스트 초기화
                    */
